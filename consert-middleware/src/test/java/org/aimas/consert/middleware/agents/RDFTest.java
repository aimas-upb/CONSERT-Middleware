...
public class RDFTest {
	...
	public void testGraphs() {
		...
		String rdfData = "@prefix protocol: <http://pervasive.semanticweb.org/ont/2017/06/consert/protocol#> .\n"
				+ "@prefix annotation: <http://pervasive.semanticweb.org/ont/2014/05/consert/annotation#> .\n"
				+ "@prefix assertion-instance: <http://pervasive.semanticweb.org/ont/2017/06/consert/protocol#AssertionInstance> .\n"
				+ "@prefix timestamp-annotation: <http://pervasive.semanticweb.org/ont/2014/05/consert/annotation#TimestampAnnotation> .\n"
				+ "@prefix certainty-annotation: <http://pervasive.semanticweb.org/ont/2014/05/consert/annotation#CertaintyAnnotation> .\n\n"
		...
		try {
			...
			Resource assertG = SimpleValueFactory.getInstance().createIRI("http://pervasive.semanticweb.org/ont/2017/06/consert/protocol#assertionGraph");
			Resource annG = SimpleValueFactory.getInstance().createIRI("http://pervasive.semanticweb.org/ont/2017/06/consert/protocol#annotationGraph");
