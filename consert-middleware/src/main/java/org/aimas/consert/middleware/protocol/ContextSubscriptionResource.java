...
/**
 * Bean class for resource containing required information to make stateless REST calls for ContextSubscriptions
 */
public class ContextSubscriptionResource {
	...
	private ContextSubscription contextSubscription;   // content of the ContextSubscription
